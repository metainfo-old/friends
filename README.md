...
[![Source](https://cdn-storage.github.io/images/badges/info.source.svg)](https://github.com/metainfo/friends)
...
[![Issues](https://cdn-storage.github.io/images/badges/info.issues.svg)](https://github.com/metainfo/friends/issues)
...
Общие друзья проектов [**METADATA**](https://metadata.foundation/).
